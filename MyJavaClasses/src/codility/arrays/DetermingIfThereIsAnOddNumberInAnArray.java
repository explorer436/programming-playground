...
returns true if there is an unpaired element in the array A.
Return false if there is no unpaired element in the array A.
...
the function should return true, as explained in the example above.
 ...
 */
public class DetermingIfThereIsAnOddNumberInAnArray
{
	public static void main(String[] args)
	{
		System.out.println("starting test class");

		DetermingIfThereIsAnOddNumberInAnArray classUnderTest = new DetermingIfThereIsAnOddNumberInAnArray();
		...
		System.out.println("result for input { 1, 2, 1, 2 } : " + classUnderTest.solution(new int[] { 1, 2, 1, 2 }));
