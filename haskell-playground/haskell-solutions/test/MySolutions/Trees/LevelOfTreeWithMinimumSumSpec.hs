module MySolutions.Trees.LevelOfTreeWithMinimumSumSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import MySolutions.Trees.LevelOfTreeWithMinimumSum (tupleWithMinimumSum, levelWithMinimumSum, minimumSum)
