...
public class VendingMachineImpl implements VendingMachine {
    ...
    @Override
    public Map<String, Long> displayItemsAndPrices() {
    ...
    @Override
    public List<InventoryItemNamePriceQuantity> displayInventoryItemsAndPrices() {

        List<InventoryItemNamePriceQuantity> l = new ArrayList<>();
        ...
        for (Item i : inventoryItemsAndQuantity.keySet()) {
            ...
            l.add(inventoryItemNamePriceQuantity);
        }
        return l;
    }
    ...
    @Override
    public ImmutablePair<Item, List<Coin>> purchaseItemAndCollectChange(Item item) {
        currentItem = item;
        collectItem(item);
        ...
        return new ImmutablePair<Item, List<Coin>>(item, change);
    }
