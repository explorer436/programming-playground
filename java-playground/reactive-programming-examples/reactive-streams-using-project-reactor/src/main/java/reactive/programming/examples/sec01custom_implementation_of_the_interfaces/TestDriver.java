package reactive.programming.examples.sec01custom_implementation_of_the_interfaces;

import lombok.extern.slf4j.Slf4j;
import reactive.programming.examples.sec01custom_implementation_of_the_interfaces.publisher.PublisherImpl;
import reactive.programming.examples.sec01custom_implementation_of_the_interfaces.subscriber.SubscriberImpl;
...
public class TestDriver {
    ...
    private static void validate_5() throws InterruptedException {
        ...
        subscriber.getSubscription().request(33); // Will give error because MAX_ITEMS = 10
        Thread.sleep(Duration.ofSeconds(2));
        log.info("-------");
