module Datastructures.Trees.MyBinarySearchTree_MaximumAndMinimumElementsSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import Datastructures.Trees.MyBinarySearchTree_MaximumAndMinimumElements (treeMinimum, treeMaximum)
