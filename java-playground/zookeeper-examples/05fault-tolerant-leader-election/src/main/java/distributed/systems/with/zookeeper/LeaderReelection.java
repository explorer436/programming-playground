...
public class LeaderReelection implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        leaderReelection.watchTargetZnode();
    ...
    public void reelectLeader() throws InterruptedException, KeeperException {
        ...
        // If the predecessorZnode that we are watching gets deleted before we call the exist() method,
        // the while loop is to keep doing this until we find an existing znode to watch for failures.
        ...
        // If the predecessorZnode gets deleted after we call the exists() method, since we have a watcher on it, the current instance will be notified by Zookeeper.
