module MySolutions.Trees.PrintNodesInBoustrophedonOrderSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import MySolutions.Trees.PrintNodesInBoustrophedonOrder (printNodesInBoustrophedonOrder)
