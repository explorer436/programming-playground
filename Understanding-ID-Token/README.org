...
#+CAPTION: Summary_of_decoding_JWS
#+NAME: Summary_of_decoding_JWS
[[./images/Summary_of_decoding_JWS.png]]
...
#+CAPTION: encrypting_party_decrypting_party
#+NAME: encrypting_party_decrypting_party
[[./images/encrypting_party_decrypting_party.png]]
...
#+CAPTION: enc (Encryption Algorithm) Header Parameter Values for JWE
#+NAME: enc (Encryption Algorithm) Header Parameter Values for JWE
[[./images/enc_Header_Parameter_Values_for_JWE.png]]
...
#+CAPTION: alg (Algorithm) Header Parameter Values for JWE
#+NAME: alg (Algorithm) Header Parameter Values for JWE
[[./images/alg_Header_Parameter_Values_for_JWE.png]]
...
#+CAPTION: JWT in JWS format
#+NAME: JWT in JWS format
[[./images/JWT_in_JWS_format.png]]
...
#+CAPTION: JWT in JWE format
#+NAME: JWT in JWE format
[[./images/JWT_in_JWE_format.png]]
...
#+CAPTION: Nested JWT (JWS in JWE pattern)
#+NAME: Nested JWT (JWS in JWE pattern)
[[./images/Nested_JWT.png]]
