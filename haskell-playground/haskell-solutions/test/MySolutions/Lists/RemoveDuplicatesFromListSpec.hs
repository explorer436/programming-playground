module MySolutions.Lists.RemoveDuplicatesFromListSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import MySolutions.Lists.RemoveDuplicatesFromList (removeDuplicateFromListLeftFold, removeDuplicateFromListRightFold)
