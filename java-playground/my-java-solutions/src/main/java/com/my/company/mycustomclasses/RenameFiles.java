...
public class RenameFiles {
  private static final String folderLocation =
      "/Users/harshavardhanedupuganti/Desktop/OCD Pirate's Library - Java Books";
  // private final static String folderLocation = "/Users/harshavardhanedupuganti/Google Drive/OCD
  // Pirate's Library - Java Books";
      ...
      for (int i = 0; i < listOfFiles.length; i++) {
        if (listOfFiles[i].isFile() && listOfFiles[i].getName().length() > 22) {
          try {
            ...
            String ext = oldName.substring(indexOfExtension, oldName.length());
