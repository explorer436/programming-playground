...
public class PrintFileNamesInAFolder {
  ...
  private static final String folderLocation =
      "/Users/harshavardhanedupuganti/Google Drive/OCD Pirate's Library - Java Books";
  private static final String catalogLocation =
      "/Users/harshavardhanedupuganti/Google Drive/OCD Pirate's Library - Java Books";
      ...
      writer =
          new BufferedWriter(
              new OutputStreamWriter(
                  new FileOutputStream(catalogLocation + "/0000Catalog.txt"), "utf-8"));
      ...
      for (int i = 0; i < listOfFiles.length; i++) {
        if (listOfFiles[i].isFile()) {
          try {
            ...
            System.out.println(
                "File name length : "
                    + listOfFiles[i].getName().substring(22, listOfFiles[i].getName().length()));
          } catch (Exception e) {
            e.printStackTrace();
          }
          ...
          readBooks(
              listOfFiles[i].getName(), folderLocation + "/" + listOfFiles[i].getName(), writer);
        }
      }
  ...
  private static void readBooks(String authorName, String location, Writer writer)
      throws IOException {
