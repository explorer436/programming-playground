 ...
 *
 * <p>Two brackets are considered to be a matched pair if the an opening bracket (i.e., (, [, or {)
 ...
 *
 * <p>A matching pair of brackets is not balanced if the set of brackets it encloses are not
 ...
 *
 * <p>By this logic, we say a sequence of brackets is balanced if the following conditions are met:
 ...
 *
 * <p>Given n strings of brackets, determine whether each sequence of brackets is balanced. If a
 * string is balanced, return YES. Otherwise, return NO.
 *
 * <p>Function Description
 *
 * <p>Complete the function isBalanced in the editor below. It must return a string: YES if the
 * sequence is balanced or NO if it is not.
 *
 * <p>isBalanced has the following parameter(s):
 *
 * <p>s: a string of brackets
 *
 * <p>Input Format
 *
 * <p>The first line contains a single integer n, the number of strings. Each of the next n lines
 * contains a single string s, a sequence of brackets.
 *
 * <p>Constraints: 1 <= n <= 10 ^ 3 1 <= |s| <= 10 ^ 3, where |s| is the length of the sequence. All
 * chracters in the sequences belongs in {, }, (, ), [, ].
 *
 * <p>Output Format For each string, return YES or NO.
 *
 * <p>Sample Input 3 {[()]} {[(])} {{[[(())]]}}
 *
 * <p>Sample Output YES NO YES
 *
 * <p>Explanation The string {[()]} meets both criteria for being a balanced string, so we print YES
