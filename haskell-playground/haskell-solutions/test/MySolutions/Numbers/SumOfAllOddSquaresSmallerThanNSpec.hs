module MySolutions.Numbers.SumOfAllOddSquaresSmallerThanNSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import MySolutions.Numbers.SumOfAllOddSquaresSmallerThanN (sumOfAllOddSquaresSmallerThanN)
