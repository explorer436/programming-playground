...
/**
 * 
	Use this only when the range of values in the array is reasonably small.
	This will not be a good use case for array with numbers that range over large numbers.
	e.g. if min = 1, max = 10,000, do not use this.
	Ideally, the range is approximately equal to the number of elements we want to sort.
 *
 */
