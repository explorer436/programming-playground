...
Where bindings are a syntactic construct that let you bind to variables at the end of a function and 
the whole function can see them, including all the guards. 
...
it was explained that an if else statement is an expression and you can cram it in almost anywhere?
-}
