module MySolutions.Trees.CountTheNumberOfNodesInACompleteBinaryTreeSpec where

import Test.Hspec
import MySolutions.Trees.CountTheNumberOfNodesInACompleteBinaryTree (numberOfNodesInCompleteBinaryTree)
