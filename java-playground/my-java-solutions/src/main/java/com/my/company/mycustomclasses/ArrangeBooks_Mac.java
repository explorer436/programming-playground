...
public class ArrangeBooks_Mac {
  private static final String sourceDirectory =
      "/Volumes/SIGNATURE/eBooks/KindleLibrary2012/Library";

  private static final String targetDirectory =
      "/Volumes/SIGNATURE/eBooks/Kindle Library (Final)/K/";
  ...
  private static void moveFile(String source, String target, String authorName, String bookName) {
    ...
    try {
      ...
      File bfile =
          new File(targetDirectory + authorName + "/" + bookName + "/" + bookName + "(lib2).mobi");
