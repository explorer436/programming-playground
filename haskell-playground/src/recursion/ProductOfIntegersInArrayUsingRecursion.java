...
public class ProductOfIntegersInArrayUsingRecursion {
	public static void main(String[] args) {
        ...
        System.out.println("productOfElements_recursion of anArray : " + ProductOfIntegersInArrayUsingRecursion.productOfElements_recursion(anArray));
        ...
        anArray = new Integer[]{5, 2, 10};
        System.out.println("productOfElements_iteration of anArray : " + ProductOfIntegersInArrayUsingRecursion.productOfElements_iteration(anArray));
    ...
    public static int productOfElements_recursion(Integer[] anArray) {
        ...
        if (null != anArray && anArray.length != 0)
        {
            ...
            {
                result = anArray[0] * productOfElements_recursion(Arrays.copyOfRange(anArray, 1, anArray.length));
            }
        }
