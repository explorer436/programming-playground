...
flatten Node a EmptyTree EmptyTree = tree
flatten Node a EmptyTree right = tree
flatten Node a left right = Node a (flatten left) right
flatten Node a left EmptyTree = helper Node a left

helper Node a left = Node a EmptyTree left
