...
* The original package name 'io.spring.dataflow.sample.usage-detail-sender-rabbit' is invalid and this project uses 'io.spring.dataflow.sample.usagedetailsenderrabbit' instead.
