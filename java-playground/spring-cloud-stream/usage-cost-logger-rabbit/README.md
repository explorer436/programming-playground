...
* The original package name 'io.spring.dataflow.usage-cost-logger-rabbit' is invalid and this project uses 'io.spring.dataflow.usagecostloggerrabbit' instead.
