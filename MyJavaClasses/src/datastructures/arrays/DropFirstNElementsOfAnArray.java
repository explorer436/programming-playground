...
public class DropFirstNElementsOfAnArray
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("result after skipping 2 elements from the beginning of the array " + Arrays.toString(A) + " is ");
		skipFirstKElementsOfArray(A, 2);
		
		System.out.println();
		
		System.out.println("result after skipping 10 elements from the beginning of the array " + Arrays.toString(A) + " is ");
		skipFirstKElementsOfArray(A, 10);
	}
	
	/**
	 * If we already know the total number of elements that should be dropped from the beginning of an array,
	 * look at the method skipFirstKElementsOfArray() below.
	 */
