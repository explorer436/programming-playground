...
public class GCDOfNumbersInAnArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sum of all elements of the array " + Arrays.toString(nums) + " calculated using stream reduce is " + getSum(nums));
	...
	{
		Integer gcdOfAllElementsOfAnArrayCalculatedUsingStreamReduce = Arrays.stream(A)
				   .reduce(
				       0,
	 ...
	 * This is not exactly used in this class - it is pasted for reference.
	 */
	public static int getSum(int[] A)
	{
		Integer totalSumCalculatedUsingStreamReduce = Arrays.stream(A)
				   .reduce(
				       0,
				       (a, b) -> a + b);
