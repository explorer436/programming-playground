...
public class LCMOfNumbersInAnArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("LCM of all elements of the array " + Arrays.toString(a) + " calculated using stream reduce is " + getLcm(Arrays.asList(a)));

	}
	
	public static int getLcm(List<Integer> inputList)
	{
		Integer lcmOfAllElementsOfAnArrayCalculatedUsingStreamReduce = inputList
				.stream()
				// .boxed()
				.reduce(
						1,
