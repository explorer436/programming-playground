module MySolutions.Trees.MyBinaryTree (Tree (..), rootValue, actualRootValue, areTreesEqual, leftAndRightTrees, leftSubtree, rightSubtree, leftNodeValue, rightNodeValue, treeHeight, treeLeftHeight, treeRightHeight, treeSize) where
