module MySolutions.Lists.UniqueElementsInAList (removeElementsWithMultipleFrequency) where

import Data.List ( nub )
import MySolutions.Lists.CountFrequencyOfElementsInAList (countFrequencyOfAnElementUsingRecursion)
