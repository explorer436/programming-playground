module Datastructures.Trees.MyBinarySearchTree_InsertSpec where
...
import Datastructures.Trees.MyBinarySearchTree_Insert (listToTreeFromRight, listToTreeFromLeft)
