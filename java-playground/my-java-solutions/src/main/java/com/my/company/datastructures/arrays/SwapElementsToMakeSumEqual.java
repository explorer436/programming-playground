 ...
 * A and B of n integers, a 0 , a 1 , . . . , a n−1 and b 0 , b 1 , . . . , b n−1 respectively (0 �
 * a i , b i � m). The goal is to check whether there is a swap operation which can be performed on
 * these arrays in such a way that the sum of elements in array A equals the sum of elements in
 * array B after the swap. By swap operation we mean picking one element from array A and one
