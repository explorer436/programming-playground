...
public class ReverseCollectionsUsingStack {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!".tset a si sihT".equals(result)) {
            throw new Exception(
                    "wrong answer - expected " + ".tset a si sihT" + " but received " + result);
        }
    ...
    public static void reverseIntegerArrayUsingStack(int[] a) {
        ...
        ImplementStackUsingSingleLinkedList<Integer> integerStack =
                new ImplementStackUsingSingleLinkedList<>();
        ...
        System.out.println(
                "size of the stack after inserting all the elements from the array : "
                        + integerStack.size());
        System.out.println();
