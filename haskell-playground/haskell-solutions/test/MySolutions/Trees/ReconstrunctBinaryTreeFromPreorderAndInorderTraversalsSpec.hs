module MySolutions.Trees.ReconstrunctBinaryTreeFromPreorderAndInorderTraversalsSpec where

import Test.Hspec
import MySolutions.Trees.ReconstrunctBinaryTreeFromPreorderAndInorderTraversals (reconstruct, leftHalfInOrder, leftHalfPreOrder, rightHalfInOrder, rightHalfPreOrder)
