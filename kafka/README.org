...
*** GUI Tool
    ...
    1. GUI tool to explore kafka setup: https://www.kafkamagic.com/ (never used this myself - don't know how this works)

    1. There are more tools listed here: https://dev.to/dariusx/recommend-a-simple-kafka-ui-tool-5gob
