module Datastructures.Trees.MyBinarySearchTree_PermutationsFromList (permuationsOfTreesFromAList) where

import Datastructures.Trees.MyBinaryTree (Tree (..))

import Datastructures.Trees.MyBinarySearchTree_Insert (listToTreeFromRight, listToTreeFromLeft, treeInsert)
