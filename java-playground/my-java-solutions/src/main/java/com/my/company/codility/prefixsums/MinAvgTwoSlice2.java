...
/**
 * A non-empty array A consisting of N integers is given. A pair of integers (P, Q), such that 0 â‰¤
 ...
 * the slice. To be precise, the average equals (A[P] + A[P + 1] + ... + A[Q]) / (Q âˆ’ P + 1).
 *
