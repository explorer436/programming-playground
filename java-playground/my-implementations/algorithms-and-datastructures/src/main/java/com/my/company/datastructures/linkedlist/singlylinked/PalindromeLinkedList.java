...
public class PalindromeLinkedList {
    ...
    public boolean isPalindrome(Node_Integer head) {
        ...
        ImmutablePair<Integer, Node_Integer> middleIndexAndPointer = singlyLinkedList.findMiddleNode(head);
        ...
        Node_Integer headOfReversedSecondHalf = singlyLinkedList.reverse_iterative(middleNode.getNext());
