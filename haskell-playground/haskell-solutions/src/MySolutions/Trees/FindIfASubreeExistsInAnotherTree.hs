module MySolutions.Trees.FindIfASubreeExistsInAnotherTree (doesSubtreeExistInParentTree) where

import MySolutions.Trees.MyBinaryTree (Tree (..), rootValue, areTreesEqual)
