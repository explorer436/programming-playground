module MySolutions.Numbers.LargestNumberUnderNDivisibleByAGivenNumberSpec where

import Test.Hspec
import MySolutions.Numbers.LargestNumberUnderNDivisibleByAGivenNumber (largestDivisible)
