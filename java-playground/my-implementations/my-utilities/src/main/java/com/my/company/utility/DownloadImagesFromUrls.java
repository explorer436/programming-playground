...
public class DownloadImagesFromUrls {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i < urlList.size() + 1; i++) {
            ...
            localFilename = "/home/explorer436/Pictures/" + fileUrl.substring(fileUrl.lastIndexOf('/') + 1, fileUrl.length());

            // localFilename = changeFileType(localFilename);
    ...
    /*private static String changeFileType(String localFilename) {
        int index = localFilename.lastIndexOf(".");
        String ext = localFilename.substring(index);
        if (StringUtils.equalsIgnoreCase(ext, ".webp")) {
            localFilename = localFilename.substring(0, index) + ".png";
        }
    ...
    private static List<String> getUrlsForImages() {
        ...
        urlList.add(
                "https://i.etsystatic.com/37875550/r/il/92160b/4231615382/il_794xN.4231615382_4jx4.jpg");
