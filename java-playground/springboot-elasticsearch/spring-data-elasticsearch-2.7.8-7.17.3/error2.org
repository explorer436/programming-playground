...
23:55:03.449 [main] INFO org.springframework.boot.test.context.SpringBootTestContextBootstrapper -- Found @SpringBootConfiguration com.example.springdataelasticsearchpoc.SpringDataElasticsearchPocApplication for test class com.example.springdataelasticsearchpoc.SpringDataElasticsearchPocApplicationTests
...
2023-12-24T23:55:03.857-05:00  INFO 2609642 --- [           main] ringDataElasticsearchPocApplicationTests : Starting SpringDataElasticsearchPocApplicationTests using Java 18.0.2 with PID 2609642 (started by explorer436 in /home/explorer436/Downloads/GitRepositories/programming-playground/java-playground/spring-data-elasticsearch-poc)
2023-12-24T23:55:03.859-05:00  INFO 2609642 --- [           main] ringDataElasticsearchPocApplicationTests : No active profile set, falling back to 1 default profile: "default"
2023-12-24T23:55:04.243-05:00  INFO 2609642 --- [           main] .s.d.r.c.RepositoryConfigurationDelegate : Bootstrapping Spring Data Elasticsearch repositories in DEFAULT mode.
2023-12-24T23:55:04.268-05:00  INFO 2609642 --- [           main] .s.d.r.c.RepositoryConfigurationDelegate : Finished Spring Data repository scanning in 21 ms. Found 1 Elasticsearch repository interface.
2023-12-24T23:55:04.387-05:00  INFO 2609642 --- [           main] .s.d.r.c.RepositoryConfigurationDelegate : Bootstrapping Spring Data Reactive Elasticsearch repositories in DEFAULT mode.
2023-12-24T23:55:04.396-05:00  INFO 2609642 --- [           main] .s.d.r.c.RepositoryConfigurationDelegate : Finished Spring Data repository scanning in 8 ms. Found 0 Reactive Elasticsearch repository interfaces.
2023-12-24T23:55:05.053-05:00  WARN 2609642 --- [           main] o.s.w.c.s.GenericWebApplicationContext   : Exception encountered during context initialization - cancelling refresh attempt: org.springframework.beans.factory.UnsatisfiedDependencyException: Error creating bean with name 'productSearchServiceWithRepo' defined in file [/home/explorer436/Downloads/GitRepositories/programming-playground/java-playground/spring-data-elasticsearch-poc/target/classes/com/example/springdataelasticsearchpoc/service/ProductSearchServiceWithRepo.class]: Unsatisfied dependency expressed through constructor parameter 0: Error creating bean with name 'productRepository' defined in com.example.springdataelasticsearchpoc.repositories.ProductRepository defined in @EnableElasticsearchRepositories declared on ElasticsearchClientConfig: Failed to instantiate [org.springframework.data.elasticsearch.repository.support.SimpleElasticsearchRepository]: Constructor threw exception
2023-12-24T23:55:05.062-05:00  INFO 2609642 --- [           main] .s.b.a.l.ConditionEvaluationReportLogger :

Error starting ApplicationContext. To display the condition evaluation report re-run your application with 'debug' enabled.
2023-12-24T23:55:05.076-05:00 ERROR 2609642 --- [           main] o.s.boot.SpringApplication               : Application run failed
...
Caused by: org.springframework.dao.DataAccessResourceFailureException: node: http://localhost:9200/, status: 200, [es/indices.exists] Missing [X-Elastic-Product] header. Please check that you are connecting to an Elasticsearch instance, and that any networking filters are preserving that header.
	...
	at org.springframework.data.elasticsearch.client.elc.IndicesTemplate.doExists(IndicesTemplate.java:177) ~[spring-data-elasticsearch-5.2.1.jar:5.2.1]
	at org.springframework.data.elasticsearch.client.elc.IndicesTemplate.exists(IndicesTemplate.java:169) ~[spring-data-elasticsearch-5.2.1.jar:5.2.1]
	at org.springframework.data.elasticsearch.repository.support.SimpleElasticsearchRepository.<init>(SimpleElasticsearchRepository.java:85) ~[spring-data-elasticsearch-5.2.1.jar:5.2.1]
...
Caused by: java.lang.RuntimeException: node: http://localhost:9200/, status: 200, [es/indices.exists] Missing [X-Elastic-Product] header. Please check that you are connecting to an Elasticsearch instance, and that any networking filters are preserving that header.
...
Caused by: co.elastic.clients.transport.TransportException: node: http://localhost:9200/, status: 200, [es/indices.exists] Missing [X-Elastic-Product] header. Please check that you are connecting to an Elasticsearch instance, and that any networking filters are preserving that header.
	at co.elastic.clients.transport.ElasticsearchTransportBase.checkProductHeader(ElasticsearchTransportBase.java:440) ~[elasticsearch-java-8.10.4.jar:na]
	at co.elastic.clients.transport.ElasticsearchTransportBase.getApiResponse(ElasticsearchTransportBase.java:304) ~[elasticsearch-java-8.10.4.jar:na]
	...
	at org.springframework.data.elasticsearch.client.elc.IndicesTemplate.lambda$doExists$2(IndicesTemplate.java:177) ~[spring-data-elasticsearch-5.2.1.jar:5.2.1]
...
Caused by: org.springframework.dao.DataAccessResourceFailureException: node: http://localhost:9200/, status: 200, [es/indices.exists] Missing [X-Elastic-Product] header. Please check that you are connecting to an Elasticsearch instance, and that any networking filters are preserving that header.
	...
	at org.springframework.data.elasticsearch.repository.support.SimpleElasticsearchRepository.<init>(SimpleElasticsearchRepository.java:85)
...
Caused by: java.lang.RuntimeException: node: http://localhost:9200/, status: 200, [es/indices.exists] Missing [X-Elastic-Product] header. Please check that you are connecting to an Elasticsearch instance, and that any networking filters are preserving that header.
	...
	... 72 more
Caused by: co.elastic.clients.transport.TransportException: node: http://localhost:9200/, status: 200, [es/indices.exists] Missing [X-Elastic-Product] header. Please check that you are connecting to an Elasticsearch instance, and that any networking filters are preserving that header.
	at co.elastic.clients.transport.ElasticsearchTransportBase.checkProductHeader(ElasticsearchTransportBase.java:440)
