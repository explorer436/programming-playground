...
@Slf4j
public class MyKafkaConsumerV1 {
    ...
    public static void main(String[] args) {
        ...
        KafkaReceiver.create(options)
                .receive()
                .doOnNext(r -> log.info("key: {}, value: {}", r.key(), r.value().toString().toCharArray()[15])) // to create a scenario where we will have an exception
