...
public class AddTwoNumbersTest {
    ...
    public void test_FindALoop_1() {
        ...
        SinglyLinkedList_Integer list1 = new SinglyLinkedList_Integer(3);
        list1.append(2);
        list1.append(1);
        SinglyLinkedList_Integer list2 = new SinglyLinkedList_Integer(7);
        list2.append(8);
        list2.append(9);
    ...
    public void test_FindALoop_3() {
        ...
        SinglyLinkedList_Integer list1 = new SinglyLinkedList_Integer(1);
        list1.append(2);
        list1.append(3);
        SinglyLinkedList_Integer list2 = new SinglyLinkedList_Integer(9);
        list2.append(8);
        list2.append(7);
    ...
    public void test_FindALoop_4() {
        ...
        list1.append(5);
        list1.append(6);
        SinglyLinkedList_Integer list2 = new SinglyLinkedList_Integer(1);
        list2.append(2);
