module MySolutions.Trees.FindIfASubreeExistsInAnotherTreeSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import MySolutions.Trees.FindIfASubreeExistsInAnotherTree (doesSubtreeExistInParentTree)
