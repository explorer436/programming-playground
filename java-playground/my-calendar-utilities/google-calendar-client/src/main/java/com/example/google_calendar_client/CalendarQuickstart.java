package com.example.google_calendar_client;
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        if (items.isEmpty()) {
            ...
            for (Event event : items) {
                ...
                System.out.printf("The event %s starts at %s.\n", event.getSummary(), start);

                System.out.println("deleting the event...");

                calendarService
                        .events()
                        .delete(CALENDAR_ID, event.getId())
                        .execute();

                System.out.println("deleted the event...");
            }
        }

        // calendarService.events().delete(CALENDAR_ID, "*");
    }

    /*
        [explorer436@explorer436-p50-20eqs27p03 google-calendar-client]$  /usr/bin/env /home/explorer436/.sdkman/candidates/java/21.0.3-zulu/bin/java @/tmp/cp_60mkyiseiua446igt2o7txmcn.argfile com.example.google_calendar_client.CalendarQuickstart
        ...
        POST https://oauth2.googleapis.com/token
        {
          ...
          "error_description": "Token has been expired or revoked."
                ...
                at com.example.google_calendar_client.CalendarQuickstart.main(CalendarQuickstart.java:72)
     */
