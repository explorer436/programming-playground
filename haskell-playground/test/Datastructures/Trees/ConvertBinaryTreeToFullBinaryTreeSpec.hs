module Datastructures.Trees.ConvertBinaryTreeToFullBinaryTreeSpec where

import Test.Hspec ( describe, it, shouldBe, Spec )
import Datastructures.Trees.MyBinaryTree (Tree (..))
import Datastructures.Trees.ConvertBinaryTreeToFullBinaryTree (convertBinaryTreeToFullBinaryTree)
