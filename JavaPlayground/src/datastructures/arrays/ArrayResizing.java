 ...
 * 
	Array resizing:
	Choosing an array to represent the stack contents implies that clients
	...
	With this implementation, the stack never overflows and never becomes less than one-
	quarter full (unless the stack is empty, when the array size is 1). We will address the
	performance analysis of this approach in more detail later.
 *
 */
