...
A negative value of d means the fruit fell units to the tree's left, and a positive value of d means it falls d units to the tree's right.
...
Apples are thrown a = [2,3,-4] units distance from a, and oranges = [3, -2, -4] units distance. 
