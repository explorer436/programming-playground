 ...
 *
 * <p>Selection sort: One of the simplest sorting algorithms works as follows:
 *
 * <p>First, find the smallest item in the array, and exchange it with the first entry. Then, find
 * the next smallest item and exchange it with the second entry. Continue in this way until the
 * entire array is sorted. This method is called selection sort because it works by repeatedly
