 ...
 * Level : Painless
 *
 * <p>Rotate an array to the right by a given number of steps.
 *
 * <p>An array A consisting of N integers is given. Rotation of the array means that each element is
 ...
 * K times.
 *
 * <p>For example, given A = [3, 8, 9, 7, 6] K = 3
 *
 * <p>the function should return [9, 7, 6, 3, 8]. Three rotations were made: [3, 8, 9, 7, 6] -> [6,
 * 3, 8, 9, 7] [6, 3, 8, 9, 7] -> [7, 6, 3, 8, 9] [7, 6, 3, 8, 9] -> [9, 7, 6, 3, 8]
 *
 * <p>For another example, given A = [0, 0, 0] K = 1
 *
 * <p>the function should return [0, 0, 0]
 *
 * <p>Given A = [1, 2, 3, 4] K = 4
 *
 * <p>the function should return [1, 2, 3, 4]
 *
 * <p>Assume that:
 *
