package com.my.company.cloud_stream_kafka_playground.sec01_simple_consumer04;
...
@Configuration
@Slf4j
public class SimpleKafkaConsumer04 {

    @Bean
    public Consumer<Flux<String>> consumer4() {
        return flux -> flux
    ...
    // Give Mono<Void> back.
    @Bean
    public Function<Flux<String>, Mono<Void>> function4() {
        return flux -> flux
